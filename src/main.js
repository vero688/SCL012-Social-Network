...
function logIn() {
  ...
  root.innerHTML = `
    ...
    <!-- post -->
    <div id="containerPost" class="cont">
        <h1>has una publicación</h1>
        <input type="text" class="postTittle" Id="postTittle" size="15" maxlength="30" placeholder="Titulo">
        <textarea type="text" class="postText" Id="postText" rows="10" cols="40">Escribe aquí tu comentario</textarea>

        <button id="postbutton" >Publicar</button> 
        <table class="postUsuario" >
            <tbody Id="postUsuario"></tbody> 
        </table>
    </div>
